      ...
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase">Abadikan Momenmu sekarang juga!</div>
           <a class="btn btn-primary btn-xl" style="margin-right: 30px; margin-top: 20px" href="login.php">MASUK</a>
            ...
            <a class="btn btn-default" data-dismiss="modal" style="margin-left: 400px; margin-bottom: 8px;" >
             ...
             <div class="col-lg-6 "> 
                 <div class="timeline-panel">
                  <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <label style="margin-right: 50px">Upload Portfolio : </label>
                            <input type="file" style="margin-top: 5px;margin-left:80px" name="gambar"  placeholder="" required autofocus="">
                            <input type="file" style="margin-top: 5px;margin-left:80px"  name="gambar2"  placeholder="" >
                            <input type="file" style="margin-top: 5px;margin-left:80px"  name="gambar3"  placeholder="" >

                          </div>
                  <div class="input-group" style="margin-top: 10px">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <label style="margin-right: 10px">Jangkauan Pemotretan: </label>
                    <select class="custom-select" name="jangkauan">
                      <option required >--Pilih Kota---</option>
                     ...
                     <div class="input-group">
                      ...
                      <div class="input-group">
                            ...
                            <textarea name="deskripsi" style="height: 100px" class="form-control" aria-label="With textarea"></textarea>
                     </div> <br> 

    
                </div>
            </div>
          </div> <a class="portfolio-link" data-toggle="modal" href="#syarat"><i>* Baca syarat dan ketentuan</i></a> <br><br>       
...
<!--Login Dulu-->
<div class="login-modal modal fade mt-5" id="LoginDulu" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
...
<!--Login Dulu-->
<div class="login-modal modal fade mt-5" id="syarat" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mx-auto mt-5">
                <div class="modal-body">
               <i  style="text-align: left;"><p>1. Fotografer harus memiliki karya foto yang akan diunggah</p><br>
               <p>2. Dalam setiap transakasi harus menerima potongan pembiayaan dari pihak admin dalam setiap transaksi</p><br>
               <p>3. Dalam penentuan harga disetiap bidang fotografi harus mengikuti harga pada umumnya.</p> </i>
      ...
      <div class="container">
        ...
        <div class="row" style="text-align: center;">
          <div class="col-lg-4">
              ...
              <h4 class="service-heading"><a class="portfolio-link" href="#LoginDulu" data-toggle="modal" data-dismiss="modal">Banyuwangi</a></h4>
          </div>
          <div class="col-lg-4">
              <span class="fa-stack fa-4x">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading"><a  class="portfolio-link" href="#LoginDulu" data-toggle="modal" data-dismiss="modal"">Lumajang</a></h4>
          </div>
          <div class="col-lg-4">
               <span class="fa-stack fa-4x">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading"><a  class="portfolio-link" href="#LoginDulu" data-toggle="modal" data-dismiss="modal"">Jember</a> </h4>
          </div>
        </div>
        <!-- <div class="row">
