...
<body>
	...
	<br/>
          ...
          <form action="cek_login.php" style=" margin-bottom: 20px;" align="center" method="post" class="navbar-form">
            <a class="btn btn-default" data-dismiss="modal" style="margin-left: 400px; margin-bottom: 8px;" >
               ...
               <h2 class="text-uppercase text-center" style="font-size: 25px; background-color: #0984e3; " >MASUK - Pelanggan</h2><br><br>
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="nama_user" class="form-control" placeholder="Nama Pelanggan" required autofocus="">
                </div>
                ...
                <br><br>
                  ...
                  <p style=" font-size: 15px">Bukan Pelanggan? Masuk Sebagai <a class="portfolio-link" href="loginfg.php" data-toggle="modal" data-dismiss="modal">Fotografer</a> atau <a href="index.php">Daftar</a></p>
					    			<?php 
										if(isset($_GET['pesan'])){
											if($_GET['pesan'] == "gagal"){
