      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Kumpulan artikel yang berisi tips untuk ibu dan balitanya</h3>
          </div>
   <?php
        
    global $mysqli;
    $jumlahDataPerhalaman = 3;
    $data = mysqli_query($koneksi, "SELECT * FROM artikel where jenis='Tips' order by id_artikel desc");
    $jumlahData = mysqli_num_rows($data);
    $jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
    $halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
    $awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;
    
    $artikel = mysqli_query($koneksi,"SELECT * FROM artikel where jenis='Tips' order by id_artikel desc limit $awalData, $jumlahDataPerhalaman ");
