...
<?php
		...
		$data = mysqli_query($config, "SELECT * FROM artikel where jenis='tips' order by id desc");
		$jumlahData = mysqli_num_rows($data);
		$jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
		$halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
		$awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;
		
		$artikel = mysqli_query($config,"SELECT * FROM artikel where jenis='tips' order by id desc limit $awalData, $jumlahDataPerhalaman ");
